    ...
    return (
      <div className="flex texts ">
        <div className="f1 p5 subtitle br ">
          ...
          <p>
            ml5.js is a friendly high level interface to TensorFlow.js, a library for handling GPU-accelerated mathematical operations and memory management
        ...
        <div className="f1 p5 subtitle">
          ...
          relationships. Additionally, ml5.js provides an API for training new models based on pre-trained ones
